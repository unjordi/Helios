...
namespace proc {
  ...
  /**
   * @brief Parse the apps file into a process manager.
   *
   * @param file_name Path to the apps JSON file.
   * @return Process manager holding the parsed apps, or nullopt on failure.
   */
