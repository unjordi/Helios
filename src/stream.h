...
namespace stream {
  ...
  namespace session {
    ...
    /**
     * @brief Get the UUID identifying a stream session.
     *
    ...
    /**
     * @brief Check whether a session matches the supplied UUID.
     *
     * @param session Active streaming or pairing session for the request.
     * @param uuid UUID to compare against.
     * @return True when the session UUID matches.
     */
    bool uuid_match(const session_t &session, const std::string_view &uuid);

    /**
     * @brief Update the device name and permissions of a live session.
     *
     * @param session Active streaming or pairing session for the request.
     * @param name New client device name.
     * @param newPerm New per-client permission mask.
     * @return True when the session state was updated.
     */
    ...
    /**
     * @brief Ask a streaming session to shut down cleanly, letting the client disconnect first.
     *
     * @param session Active streaming or pairing session for the request.
     */
