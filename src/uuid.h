...
namespace uuid_util {
  ...
  union uuid_t {
    ...
    /**
     * @brief Parse a UUID from its canonical text form.
     *
     * @param uuid_str Canonical UUID string (`xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx`).
     * @return UUID parsed from the supplied string.
     */
    static uuid_t parse(std::string &uuid_str) {
