class HeliosVersion {
  ...
  isGreater(otherVersion, checkIncremental) {
    ...
    if (otherVersion instanceof HeliosVersion) {
      ...
      throw new Error('Invalid argument: otherVersion must be a HeliosVersion object or a version string');
    }
